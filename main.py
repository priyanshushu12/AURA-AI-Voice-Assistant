...
def generate_response(user_input):
    ...
    elif any(keyword in user_input_lower for keyword in ["what is your Friend name", "what's your friend name", "what is friend name"]):
        return "My father name is Priyanshu Shukla."
    elif any(keyword in user_input_lower for keyword in ["what is your brother name", "what's your brother name"]):
        return "My brother name is Pushpendra Rajpoot."
    elif any(keyword in user_input_lower for keyword in ["what is your uncle name", "what's your uncle name"]):
        return "My uncle name is Shiva Yadav."
